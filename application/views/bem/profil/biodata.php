            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                PENDAFTAR - BEM KEMA TELKOM UNIVERSITY 2019
                            </h2>
                        ...
                        <div class="body">
                            ...
                            <form  action="<?php echo base_url('kelolaAkun/updateInfo'); ?>" id="sign_in" method="post">	
                                <?php foreach ($dataPendaftar as $data) { ?>

                                <label for="email_address">Nomor Induk Mahasiswa (NIM)</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="nim" name="nim" class="form-control" value="<?= $data->nim;?>" placeholder="Nomor Induk Mahasiswa (NIM)">
                                    </div>
                                </div>
                                <label for="password">Nama Lengkap</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="namaLengkap"  value="<?= $data->namaLengkap;?>" name="namaLengkap" class="form-control" placeholder="Nama Lengkap">
                                    </div>
                                </div>
                                <label for="password">Tempat, Tanggal Lahir</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="ttl" name="ttl" value="<?= $data->ttl;?>" class="form-control" placeholder="Tempat, dan Tanggal Lahir">
                                    </div>
                                </div>
                                <label for="password">Program Studi</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="programStudi" value="<?= $data->programStudi;?>"  name="programStudi" class="form-control" placeholder="Program Studi">
                                    </div>
                                </div>-
                                ...
                                <input name="angkatan" type="radio" id="2017" value="2017"  />
                                <label for="2017">2017</label>

                                <input name="angkatan" type="radio" id="2016" value="2016"  />
                                <label for="2016">2016</label>


                                <input name="angkatan" type="radio" id="2015"  value="2015" />
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="alamat" name="alamat" class="form-control" value="<?= $data->alamat;?>" placeholder="Alamat Lengkap" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="noHp" value="<?= $data->noHp;?>" name="noHp" class="form-control" placeholder="Nomor yang Dapat Dihubungi">
                                    </div>
                                </div>

                                <label for="password">ID Line</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="iDline"  name="iDline" value="<?= $data->idLine;?>" class="form-control" placeholder="ID Line">
                                    </div>
                                </div>

                                <label for="password">Pengalaman Organisasi/Kepanitiaan</label>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <textarea name="pengalamanOrganisasi" cols="30" rows="5" class="form-control no-resize"  ><?= $data->pengalamanOrganisasi;?></textarea>
                                        <label class="form-label">Pengalaman Organisasi Maupun Kepanitian</label>
                                    </div>
                                </div>

                                <label for="password">Ceritakan Keahlian Anda</label>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <textarea name="keahlian" cols="30" rows="5" class="form-control no-resize"  ><?= $data->keahlian;?></textarea>
                                        <label class="form-label">Ceritakan Keahlian Anda</label>
                                    </div>
                                </div>

                                <label for="password">Harapan Untuk BEM KEMA TEL-U 2019</label>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <textarea name="harapan" cols="30" rows="5" class="form-control no-resize" ><?= $data->harapan;?></textarea>
                                        <label class="form-label">Harapan Anda Untuk BEM KEMA TEL-U 2019</label>
                                    </div>
                                </div>
                                
                                <input type="checkbox" id="remember_me" class="filled-in" required>
                                <label for="remember_me">Data yang Saya Masukkan Sudah Sesuai</label>
                                <br>
                                <td><input type="submit" value="Submit" class="btn btn-primary m-t-15 waves-effect"></td>
